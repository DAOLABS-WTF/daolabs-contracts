...
describe('JBSingleTokenPaymentTerminalStore::currentReclaimableOverflowOf(...)', function () {
    ...
    it('Should return claimable overflow from this terminal, with rate from active ballot', async function () {
        ...
        */
        ...
        expect(await JBSingleTokenPaymentTerminalStore['currentReclaimableOverflowOf(address,uint256,uint256,bool)'](mockJbTerminalSigner.address, PROJECT_ID, /* tokenCount */ tokenAmt, false))
            .to.equal(ethers.FixedNumber.fromString('41.25').toHexString());
    });
    ...
    it('Should return claimable overflow with rate from active ballot, accross all terminals using the same currency and decimals', async function () {
        ...
        */
        ...
        // Get claimable overflow where tokenCount is half the total supply of tokens
        expect(await JBSingleTokenPaymentTerminalStore['currentReclaimableOverflowOf(address,uint256,uint256,bool)'](mockJbTerminalSigner.address, PROJECT_ID, /* tokenCount */ tokenAmt, true))
            .to.equal(ethers.FixedNumber.fromString('82.5').toHexString());
    });
    ...
    it('Should return claimable overflow amount of this terminal if redemption rate is 100%', async function () {
        ...
        */
        ...
        // Get claimable overflow where tokenCount is half the total supply of tokens
        expect(await JBSingleTokenPaymentTerminalStore['currentReclaimableOverflowOf(address,uint256,uint256,bool)'](mockJbTerminalSigner.address, PROJECT_ID, /* tokenCount */ tokenAmt, false)).to.equal(ethers.FixedNumber.from(50).toHexString());
    });
    ...
    it('Should return claimable overflow when no terminal is passed, with rate from the current cycle', async function () {
        ...
        */
        ...
        // Get claimable overflow where tokenCount is half the total supply of tokens
        expect(await JBSingleTokenPaymentTerminalStore['currentReclaimableOverflowOf(uint256,uint256,uint256,uint256)'](
            PROJECT_ID,
            /* tokenCount */ tokenAmt,
            /* totalSupply */ totalSupply,
            /* overflow */ overflowAmt
